...
import { Lots, Replenishment, Transfers, Valuation } from './InventoryPlanning';

const views = [
  ['overview', 'Resumen'], ['stock', 'Existencias'], ['receiving', 'Recepción'], ['purchase-orders', 'Órdenes de compra'], ['preparations', 'Preparaciones'],
  ['replenishment', 'Reabastecimiento'], ['lots', 'Lotes'], ['transfers', 'Transferencias'], ['valuation', 'Valuación'],
