...
from app.api.routes.inventory_preparations import router as inventory_preparations_router
from app.api.routes.inventory_replenishment_lots_valuation import router as inventory_b10_router
from app.api.routes.inventory_fifo_transfers import router as inventory_b11_router
...
from app.api.routes.identity_access import router as identity_access_router
...
from app.api.routes.paid_check_printing import router as paid_check_printing_router
...
def create_app(
    ...
    app.include_router(inventory_preparations_router)
    app.include_router(inventory_b10_router)
    app.include_router(inventory_b11_router)
